...
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            $id = $_GET['id'];
            $q = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM `register` WHERE `id` = $id"));
            ?>
            <div class="col-10 col-md-8 align-content-center box pt-5">
                ...
                <div class="p-2 d-flex">
                    <h3>Email Id:&nbsp;</h3>
                    <h3 class="fw-bold"> <?php echo $q[3] ?></h3>
                </div>
                <div class="p-2 d-flex">
                    <h3>Password:&nbsp;</h3>
                ...
                <div class="inp p-2" id="inpp">
                    <form action="cchange_pass.php?id=<?php echo $_GET['id']; ?>" class="d-flex" method="post">
